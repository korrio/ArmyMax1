...
public final class FollowerGridViewAdapter extends BaseAdapter {
	private final Context context;
	private final List<String> urls;
	private final List<String> names;

	public FollowerGridViewAdapter(Context context) {
		this.context = context;

		// Ensure we get a different ordering of images on each run.
		urls = DataFollower.getURLS();
		names = DataFollower.getNAMES();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String url = DataFollower.getUrl(position);
		String name = DataFollower.getName(position);
