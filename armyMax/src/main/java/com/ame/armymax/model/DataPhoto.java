...
public class DataPhoto {
	...
	private static ArrayList<String> photoSources = new ArrayList<String>();
	...
	public static String getPhotoSource(int i) {
		return photoSources.get(i);
	}
	
	public static void setPhotoSource(String name) {
		photoSources.add(name.toString());
	}
