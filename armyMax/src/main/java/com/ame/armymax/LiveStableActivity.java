...
public class LiveStableActivity extends Activity implements OnClickListener {
	
    private final static String LOG_TAG = "MainActivity";

    private PowerManager.WakeLock mWakeLock;

	//private String ffmpeg_link = "rtmp://150.107.31.6:1935/live/armymax1";
    ...
    private void initLayout() {
    	//RelativeLayout myLayout = (RelativeLayout) findViewById(R.id.record_layout);
